...
import com.keeptoken.p2p.peer.network.PeerChannelHandler;
import com.keeptoken.p2p.peer.network.PeerChannelInitializer;
...
public class PeerHandle {
    ...
    public PeerHandle(Agent agent, Config config, int portToBind) {
        this.agent = agent;
        this.config = config;
        ...
        this.peer = new Peer(agent, config, connectionService, pingService, leadershipService);
    }
